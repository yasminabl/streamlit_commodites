...
sub_df_wheat_ind.index = pd.to_datetime(sub_df_wheat_ind.index)

selected_year_min, selected_month_min, selected_year_max, selected_month_max = get_date_range_from_sidebar(sub_df_wheat_ind)

sub_df_wheat_ind_filtered = filter_dataframe(sub_df_wheat_ind, 
...
display_custom_table(df_wheat, "Données descriptives sur le café")

# ___________________________________________ Generate Graphs ___________________________________________

fig1, title1 = graph_cours_boursier_long_term(sub_df_wheat_ind_filtered, selected_commodity, commodite)
...
display_graphs_long_term(
    ...
    text_column_content="""
        ...
        Les graphiques ci-dessus montrent l'évolution à long terme des cours du blé et des indices associés. 

...
st.sidebar.markdown('[Moyennes Mobiles](#moyennes_mobiles)', unsafe_allow_html=True)
st.sidebar.markdown('[Lissage Exponentiel Simple](#les)', unsafe_allow_html=True)
st.sidebar.markdown('[Lissage Exponentiel Double](#led)', unsafe_allow_html=True)
st.sidebar.markdown('[Holt & Winter](#h&w)', unsafe_allow_html=True)
#_______________________________________________________________________________________________________________________

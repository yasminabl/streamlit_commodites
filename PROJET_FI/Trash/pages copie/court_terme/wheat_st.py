...
#_____________________________________________wheat_court_terme_________________________________________________________
...
with col1 :
    ...
    st.dataframe(df_wheat.iloc[:13,:])


with col2 :
    st.subheader("Données descriptive sur le café")
    st.dataframe(df_wheat.iloc[:13,:].describe())
...
sub_df_wheat_filtered = sub_df_wheat.iloc[:13,:]
...
st.line_chart(sub_df_wheat_filtered[columns_to_display])
#_______________________________________________________________________________________________________________________
...
if 'MM' in selected_indicators:
    fig.add_trace(go.Scatter(x=sub_df_wheat_ind_filtered.index, y=sub_df_wheat_ind_filtered['MM_20'], mode='lines', name='MM_20'))
    fig.add_trace(go.Scatter(x=sub_df_wheat_ind_filtered.index, y=sub_df_wheat_ind_filtered['MM_200'], mode='lines', name='MM_200'))

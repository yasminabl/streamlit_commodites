...
#_____________________________________________index_court_terme_________________________________________________________
...
with col1 :
    ...
    st.dataframe(df_index.iloc[:13,:])


with col2 :
    st.subheader("Données descriptive sur le café")
    st.dataframe(df_index.iloc[:13,:].describe())
...
df_index_filtered = df_index.iloc[:13,:]

df_index_ind_filtered = df_index_ind.iloc[:13,:]
...
if 'MM' in selected_indicators:
    fig.add_trace(go.Scatter(x=df_index_ind_filtered.index, y=df_index_ind_filtered['MM_20'], mode='lines', name='MM_20'))
    fig.add_trace(go.Scatter(x=df_index_ind_filtered.index, y=df_index_ind_filtered['MM_200'], mode='lines', name='MM_200'))

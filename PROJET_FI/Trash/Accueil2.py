...
marquee_html = """
<div style="overflow: hidden; white-space: nowrap; background-color: #f8f9fa; padding: 10px; border: 1px solid #ddd;">
    <span style="display: inline-block; font-size: 24px; color: #333; font-weight: bold; animation: scroll-left 10s linear infinite;">
...
# HTML and CSS code for animation with Markdown
html_code = """
<div style="position: relative; height: 200px; width: 100%; background-color: #f8f9fa; overflow: hidden; border: 1px solid #ddd; display: flex; justify-content: center; align-items: center;">
    <!-- Image from the left -->
    <img src="images/image_gauche.png" alt="Image gauche" 
         style="position: absolute; left: -150px; animation: move-right 3s ease-in-out forwards; height: 100px;">

    <!-- Image from the right -->
    <img src="images/image_droite.png" alt="Image droite" 
         style="position: absolute; right: -150px; animation: move-left 3s ease-in-out forwards; height: 100px;">
</div>

<style>
/* Animation for the left image moving to the center */
@keyframes move-right {
    0% { left: -150px; } /* Start off-screen left */
    100% { left: calc(50% - 75px); } /* Center aligned */
}

/* Animation for the right image moving to the center */
@keyframes move-left {
    0% { right: -150px; } /* Start off-screen right */
    100% { right: calc(50% - 75px); } /* Center aligned */
}
</style>
"""

# Use st.markdown to display the HTML and CSS
